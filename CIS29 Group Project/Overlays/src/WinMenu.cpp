...
void WinMenu::initializeGUI(sf::Font& font)
{
	float width = 250.f;
	float height = 75.f;
...
WinMenu::WinMenu(sf::RenderWindow* renderWindow, sf::Font& font)
...
void WinMenu::setIsInputtingName(const bool& isInputtingName)
{
	this->isInputtingName = isInputtingName;
}

const bool WinMenu::getIsInputtingName() const
{
